...
roflcopter 
.DESCRIPTION
roflcopter's powershell reverse shell used for netcatting and for roflcopter's use. Can be paired with delorean.
the code is written by tom samratashok, reappropriated by trollface security for roflcopter.
.PARAMETER IPAddress
